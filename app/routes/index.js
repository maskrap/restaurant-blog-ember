...
var articles = [{
  ...
  title-list-view: "The 'Two Per Country' Gymnastics Rule Isn't New",
  title-detail-view: "When Was The Gymnastics 'Two Per Country' Rule Instated? The Olympics Have Made Many Changes Over The Years",
  category: "Entertainment",
  timestamp: "3:00pm",
  author: "Leah Thomas",
  body-copy: "Rules are always changing at the Olympics. At the 2020 Summer Games, gymnastics teams will consist of four athletes instead of five or more, which is one the the reasons that this year's group of American ladies are calling themselves 'The Final Five.' However, that's not the rule that is getting all of the attention in Rio. When was the two-per-country gymnastics rule instated at the Olympics? While frustrating for fans of Team USA at the moment, the rule that states only two gymnasts can represent their country in the individual all-around and event finals has been around for quite a while.",
